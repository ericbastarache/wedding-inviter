          ...
          <div className="row">
            <div className="col-md-12">
              <div className="content-holder">
                ...
                <p className="hero-text text-center">Using this simple inviter you'll never have to worry about lost invitations again. And it's super easy to know when your invititation has received a reply.</p>
                <div className="row">
